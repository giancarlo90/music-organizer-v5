...
public class MusicOrganizer
{
    ...
    /**
     * Muestra los datos de todos los Tracks con Iterador
     */
    ...
    /**
     * Metodo que permite eliminar tracks que tengan un determinado artista.
     */
    public void removeByArtist(String artista)
    {
        ...
        while (ite.hasNext()) {
            Track a = ite.next();
            if (a.getArtist().contains(artista)){
                ite.remove();
            }
        }
    }
    ...
    /**
     * Metodo que permite eliminar tracks que tengan un determinado titulo.
     */
